...
namespace RaymiMusic.Api.Controllers
{
    ...
    public class ReproduccionesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Reproduccion>> PostReproduccion(Reproduccion reproduccion)
        {
            ...
            return CreatedAtAction("GetReproduccion", new { id = reproduccion.Codigo }, reproduccion);
        }
        ...
        {
            return _context.Reproducciones.Any(e => e.Codigo == id);
        }
    }
}
